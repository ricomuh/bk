                                    ...
                                    <div class="list-group">
                                        ...
                                        <div class="px-4 py-3 mb-2 border-0 rounded list-group-item bg-light">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span class="font-medium">{{ $janjiPeriksa->jadwalPeriksa->dokter->nama ?? 'Tidak Diketahui' }}</span>
                                            </div>
                                        </div>
                                        <div class="px-4 py-3 mb-2 border-0 rounded list-group-item bg-light">
                                            <div class="d-flex justify-content-between">
                                                <span class="text-gray-700">Hari Pemeriksaan</span>
                                                <span class="font-medium">{{ $janjiPeriksa->jadwalPeriksa->hari ?? 'Tidak Diketahui' }}</span>
                                            </div>
                                        </div>
                                        <div class="px-4 py-3 mb-2 border-0 rounded list-group-item bg-light">
                                            <div class="d-flex justify-content-between">
                                                <span class="text-gray-700">Jam Mulai</span>
                                                <span class="font-medium">{{ $janjiPeriksa->jadwalPeriksa->jam_mulai ?? 'Tidak Diketahui' }}</span>
                                            </div>
                                        </div>
                                        <div class="px-4 py-3 mb-2 border-0 rounded list-group-item bg-light">
                                            <div class="d-flex justify-content-between">
                                                <span class="text-gray-700">Jam Selesai</span>
                                                <span class="font-medium">{{ $janjiPeriksa->jadwalPeriksa->jam_selesai ?? 'Tidak Diketahui' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="p-4 rounded bg-light h-100 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="text-white rounded-lg bg-primary d-flex align-items-center justify-content-center" style="width: 100px; height: 100px;">
                                            <span class="font-bold" style="font-size: 2.5rem;">{{ $janjiPeriksa->no_antrian ?? 'Tidak Diketahui' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>

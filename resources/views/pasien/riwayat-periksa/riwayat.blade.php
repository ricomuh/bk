                                ...
                                <div class="border-black col-md-6 border-end">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            {{ $janjiPeriksa->periksa->tgl_periksa->format('d F Y') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            {{ $janjiPeriksa->periksa->catatan ?? 'Tidak Diketahui' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="list-group list-group-flush">
                                @foreach ($janjiPeriksa->periksa->detailPeriksas as $detail)
                                    <li class="px-0 list-group-item d-flex justify-content-between align-items-center border-bottom">
                                        <span>{{ $detail->obat->nama_obat ?? 'Tidak Diketahui' }}</span>
                                        <span class="badge bg-light text-dark">{{ $detail->obat->kemasan ?? 0 }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold fs-5 text-primary">
                                    {{ Number::currency($janjiPeriksa->periksa->biaya_periksa ?? 0, 'IDR') }}
                                </span>
                            </div>
                        </div>
                    </div>
